...
def apply_hair_removal(image_path: Path):
    logger.info("Applying hair removal in %s", image_path)

    alg_name = "hair_removal"
    ...
    if res_image_path.exists():
        logger.info("Hair removal is already applied, ignoring...")
        return
